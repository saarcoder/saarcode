    ...
    <nav>
      ...
      <ul>
        {#each navLinks as navLink}
          <li>
            <a
              class={active_tab === navLink.link ? "active" : ""}
              href={navLink.link}>{navLink.name}</a
            >
          </li>
        {/each}
      </ul>
...
<footer class="diagonal">
  <div class="container">
    <p class="editor-link">
      <a href="cloudcannon:data/data/footer.json" class="btn"
        ><strong>&#9998;</strong> Footer bearbeiten</a
      >
    </p>
  ...
  <div class="legal-line">
    <p class="container">
      ...
      {companyData.site_title} &bull; Template: Urban von
      <a href="https://cloudcannon.com/">CloudCannon</a>
    </p>
  </div>
</footer>
